System.register("script/js/materialize.min", [], function($__export) {
  "use strict";
  var __moduleName = "script/js/materialize.min";
  var Vel;
  return {
    setters: [],
    execute: function() {
      jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        ...
        if (!a.jQuery) {
          ...
          c.isWindow = function(a) {
            ...
            return null == a ? a + "" : "object" == (typeof a === 'undefined' ? 'undefined' : $traceurRuntime.typeof(a)) || "function" == typeof a ? e[g.call(a)] || "object" : (typeof a === 'undefined' ? 'undefined' : $traceurRuntime.typeof(a));
            ...
            var a,
                ...
                j = arguments.length,
                k = !1;
            for ("boolean" == typeof h && (k = h, h = arguments[i] || {}, i++), "object" != (typeof h === 'undefined' ? 'undefined' : $traceurRuntime.typeof(h)) && "function" !== c.type(h) && (h = {}), i === j && (h = this, i--); j > i; i++)
        ...
        "object" == (typeof module === 'undefined' ? 'undefined' : $traceurRuntime.typeof(module)) && "object" == $traceurRuntime.typeof(module.exports) ? module.exports = a() : "function" == typeof define && define.amd ? define(a) : a();
      }(function() {
 ...
 while (Math.abs(f) > r && ++h < s);
          ...
          var m,
              ...
              p = {
                ...
                isNodeList: function(a) {
                  return "object" == (typeof a === 'undefined' ? 'undefined' : $traceurRuntime.typeof(a)) && /^\[object (HTMLCollection|NodeList|Object)\]$/.test(Object.prototype.toString.call(a)) && a.length !== d && (0 === a.length || "object" == $traceurRuntime.typeof(a[0]) && a[0].nodeType > 0);
                },
        ...
        function l(a, b) {
          return (typeof a === 'undefined' ? 'undefined' : $traceurRuntime.typeof(a)) == ka ? a.apply(b ? b[0] || d : d, b) : a;
        }
        function m(a, b) {
          return a === d ? b : a;
        }
        ...
        fa.prototype = {
          ...
          bindFn: k,
          prefixed: v
        }), (typeof define === 'undefined' ? 'undefined' : $traceurRuntime.typeof(define)) == ka && define.amd ? define(function() {
          return ea;
        }) : "undefined" != typeof module && module.exports ? module.exports = ea : a[c] = ea;
      }(window, document, "Hammer"), function(a) {
        "function" == typeof define && define.amd ? define(["jquery", "hammerjs"], a) : "object" == (typeof exports === 'undefined' ? 'undefined' : $traceurRuntime.typeof(exports)) ? a(require("jquery"), require("hammerjs")) : a(jQuery, Hammer);
      }(function(a, b) {
        function c(c, d) {
          var e = a(c);
      ...
      Vel = $ ? $.Velocity : Velocity, function(a) {
        ...
        a.fn.tabs = function(c) {
          return b[c] ? b[c].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != (typeof c === 'undefined' ? 'undefined' : $traceurRuntime.typeof(c)) && c ? void a.error("Method " + c + " does not exist on jQuery.tooltip") : b.init.apply(this, arguments);
        }, a(document).ready(function() {
          a("ul.tabs").tabs();
        });
      }(jQuery), function(a) {
        ...
        function e(a) {
          ...
          if (b.classList.add("toast"), c)
            for (var e = c.split(" "),
                ...
                g = e.length; g > f; f++)
              b.classList.add(e[f]);
          ("object" == (typeof HTMLElement === 'undefined' ? 'undefined' : $traceurRuntime.typeof(HTMLElement)) ? a instanceof HTMLElement : a && "object" == (typeof a === 'undefined' ? 'undefined' : $traceurRuntime.typeof(a)) && null !== a && 1 === a.nodeType && "string" == typeof a.nodeName) ? b.appendChild(a) : a instanceof jQuery ? b.appendChild(a[0]) : b.innerHTML = a;
        ...
        a.fn.sideNav = function(c) {
          return b[c] ? b[c].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != (typeof c === 'undefined' ? 'undefined' : $traceurRuntime.typeof(c)) && c ? void a.error("Method " + c + " does not exist on jQuery.sideNav") : b.init.apply(this, arguments);
        };
      }(jQuery), function(a) {
        function b(b, c, d, e) {
          var f = a();
        ...
        "function" == typeof define && define.amd ? define("picker", ["jquery"], a) : "object" == (typeof exports === 'undefined' ? 'undefined' : $traceurRuntime.typeof(exports)) ? module.exports = a(require("jquery")) : this.Picker = a(jQuery);
      }(function(a) {
        function b(f, g, i, l) {
          function m() {
        ...
        "function" == typeof define && define.amd ? define(["picker", "jquery"], a) : "object" == (typeof exports === 'undefined' ? 'undefined' : $traceurRuntime.typeof(exports)) ? module.exports = a(require("./picker.js"), require("jquery")) : a(Picker, jQuery);
      }(function(a, b) {
        function c(a, b) {
          var c = this,
              d = a.$node[0],
